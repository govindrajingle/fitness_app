...
//        Backup you can passer user id also if keycloak id is not present
    ...
    //    Extract user details from jwt token from key cloak
...
//            If password is not present it should ask in prompt
