...
import {getActivityDetail} from "../service/api.js";
...
const ActivityDetail = () => {
    ...
    return (<Box sx={{maxWidth: 800, mx: 'auto', p: 2}}>
        <Card sx={{mb: 2}}>
            <CardContent>
        ...
        {recommendation && (<Card>
            <CardContent>
                ...
                {activity?.safety?.map((safety, index) => (<Typography key={index} paragraph>• {safety}</Typography>))}
            </CardContent>
        </Card>)}
    </Box>)
}
